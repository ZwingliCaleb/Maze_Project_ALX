...
enemy_t enemies[num_enemy] = {
	{79.4, 84.4, 0, "images/shooter001.png"},
	{250.5, 100, 5, "images/gunman002.png"},
	{390.5, 205, 5, "images/gunman003.png"},
	{430, 384, 5, "images/shooter001.png"},
	{80.3, 445.7, 5, "images/gunman001.png"}
};

/**
 * add_weapon - function to draw weapon
...
void add_weapon(SDL_Instance ins)
{
	...
	SDL_Rect gun;
	int w, h;
	SDL_Surface *surf = IMG_Load("images/gun001.png");
