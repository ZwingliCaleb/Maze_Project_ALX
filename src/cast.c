...
float buff[num_rays];
/**
 * ray_cast - function that casts an array to the wall
...
/**
 * horizontal_collision - function that checks for horizontal collision
 * @ray_a: angle of ray
 ...
 * @hmtx: the horizontal map texture value
 *
 * Return: nothing
 **/
 ...
 * @vd: references the vertical distance
 * @vx: references the vertical x-coordinate
 * @vy: references the vertical y-coordinate
